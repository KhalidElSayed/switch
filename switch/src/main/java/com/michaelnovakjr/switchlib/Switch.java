...
public class Switch extends CompoundButton {
    ...
    public Switch(Context context, AttributeSet attrs, int defStyle) {
        ...
        setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                /* Really dumb that this makes the widget work. */
            }
        });
    ...
    public void setSwitchTextAppearance(Context context, int resid) {
        TypedArray appearance =
                context.obtainStyledAttributes(resid, R.styleable.TextAppearanceSwitch);
    ...
    /**
     * Provides backwards compatibilty for the right to left view support.
     *
     * @return True if right to left and False if left to right.
     */
